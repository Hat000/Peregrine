# Verbatim copy of TOGT-Planner/scripts/togt_refine/optimization.py (MIT, (c) 2024 FSC Lab,
# github.com/FSC-Lab/TOGT-Planner), vendored for the Peregrine VQ1 time-optimal bound
# (laptop-togt-bound-2026-06-10). Only this header was added.
import numpy as np
import casadi as ca
