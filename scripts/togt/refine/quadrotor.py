# Copied from TOGT-Planner/scripts/togt_refine/quadrotor.py (MIT, (c) 2024 FSC Lab,
# github.com/FSC-Lab/TOGT-Planner) for the Peregrine VQ1 time-optimal bound
# (laptop-togt-bound-2026-06-10). Peregrine changes, marked "# PEREGRINE":
#   - Quadrotor: optional `linear_drag` config key (1/s) -> isotropic world-frame linear
#     drag `-linear_drag * v` in the velocity derivative (matches racer.twin.CtbrPlant's
#     measured 0.21/s model; isotropic, so body-vs-world frame is immaterial).
