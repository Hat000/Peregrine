...
- **#30 / #58** 🟢 **ACTIVATED (2026-06-14) — two overnight ultracode/extra sessions DISPATCHED:** (A) VQ2 photoreal Blender/Cycles dataset GENERATOR (bpy, runnable on ShadowPC — intrinsics==K[[320,0,320],[0,320,180]] @640x360 +20° mount, appearance-randomized incl. VQ1-red+wide-hue to kill gambling-red overfit, Cycles photoreal + motion-blur/flares, keypoint-aware albumentations, YOLO-pose labels matching src/racer/vision/{synthetic,detector,gate_pose}.py, 5 scenario presets, viz-verify; handoff/vq2-blender-dataset-2026-06-14) + (B) YOLO-pose train+sim-to-real-eval harness extending cluster/yolo_train_v3.sbatch (Adroit AUP, scene-split, VQ1-generalization eval, PnP sanity; handoff/vq2-detector-train-2026-06-14). Grounded in EXISTING vision+training stack (not reinvented). Morning: ShadowPC runs A → upload → Adroit trains via B. Both report branches UP for commander merge. → was [[index-vision-estimator]] P5 photoreal.
