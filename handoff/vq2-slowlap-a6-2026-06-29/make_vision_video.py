...
NOTE: the live capture drops ~55% of frames (see handoff/vq2-video-timing-2026-06-29) because the
navigator runs ~450ms/tick -> the footage is genuinely sparse; that is a stack perf issue, not this render.
"""
