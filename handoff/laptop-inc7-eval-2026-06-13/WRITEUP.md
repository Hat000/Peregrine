...
### Seed 2 — PENDING RESOURCES at last check
...
| s1 | 3270606 | `/scratch/network/fl3689/inc7_runs/inc7_s1/checkpoints/actor.pth` | TBD | TBD | TBD |
| s2 | 3270608 | `/scratch/network/fl3689/inc7_runs/inc7_s2/checkpoints/actor.pth` | TBD | TBD | TBD |
...
| s2 | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD |

Note: s1 = COLLAPSED — 100% miss on VQ1 (training stuck at sr≈0.11 since iter 1000). s2 started
running at 20:31 UTC; eval results pending (~30 min).

### Generalization (--course random --plant mixer; ~2348 episodes random course)

| seed | gen_sr | t_med (s) | tilt_max_succ | coll | miss | oob |
|------|--------|-----------|----|---|---|---|
| s0 | **0.924** | 10.69 | 72.5° | 7.6% | 0.0% | 0.0% |
| s1 | **0.000** | — | — | 0.0% | 100.0% | 0.0% |
| s2 | TBD | TBD | TBD | TBD | TBD | TBD |
| **viable mean** | TBD (s0+s2 only) | TBD | TBD | — | — | — |
...
Winner: **TBD** (stage1_inc7_actor.pth)  
Commit: TBD  
md5: TBD
...
## MEMORY-DELTA:
(to be filled on completion — ≤10 lines)
