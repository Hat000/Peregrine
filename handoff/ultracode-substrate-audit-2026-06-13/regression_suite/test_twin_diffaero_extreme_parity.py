...
# --- locate the shared substrate (scratch/_audit_io.py) + repo src -------------------------------
_HERE = Path(__file__).resolve()
_SCRATCH = _HERE.parents[1] / "scratch"          # .../ultracode-substrate-audit-2026-06-13/scratch
_ROOT = _HERE.parents[3]                          # repo root
for _p in (str(_SCRATCH), str(_ROOT / "rl"), str(_ROOT / "src")):
