...
# --- paths: repo root, the shared substrate (_audit_io), and rl/ for the in-scope deploy code ---
_THIS = Path(__file__).resolve()
ROOT = _THIS.parents[3]                              # .../regression_suite/.. /.. /.. = repo root
_SCRATCH = ROOT / "handoff/ultracode-substrate-audit-2026-06-13/scratch"
for _p in (str(_SCRATCH), str(ROOT / "rl"), str(ROOT / "src")):
