...
# --- locate the shared substrate (scratch/_audit_io.py) and import it ----------------
_THIS = Path(__file__).resolve()
# .../handoff/ultracode-substrate-audit-2026-06-13/regression_suite/<this>
_AUDIT_ROOT = _THIS.parents[1]                       # ultracode-substrate-audit-2026-06-13
_SCRATCH = _AUDIT_ROOT / "scratch"
if str(_SCRATCH) not in sys.path:
    sys.path.insert(0, str(_SCRATCH))

import _audit_io as A  # noqa: E402  (path inserted above)
...
_REPO_ROOT = _AUDIT_ROOT.parents[1]      # ultracode-... -> handoff -> repo root
