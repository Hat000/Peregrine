...
# --- wire up the shared substrate + the production module under test ----------
_THIS = Path(__file__).resolve()
_SCRATCH = _THIS.parents[1] / "scratch"
_ROOT = _THIS.parents[3]                       # repo root
for _p in (str(_SCRATCH), str(_ROOT / "rl"), str(_ROOT / "src"), str(_ROOT / "scripts")):
