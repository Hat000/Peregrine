...
EXPECTED_KEYS = {
    ...
    "track_loww_ticks", # TURN b1: consecutive fresh-low-weight frame counter (null when no seeker)
    "vert_vz_imu",      # R2-2 A-1: the parallel IMU-only washout vz (terminal-brake source; null when off)
}
