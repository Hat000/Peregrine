...
#
# Read ALL the PRE-LAUNCH FLAGS in launch_vtrackAr5.sh (rw_cross_zero_m precedence; finish_time key;
# return_norm deferred; the INERT course_lateral_offset_* / ego_coarse_map_live tokens; deploy governor
# separate) -- they apply here too.
# =====================================================================================================
set -euo pipefail
